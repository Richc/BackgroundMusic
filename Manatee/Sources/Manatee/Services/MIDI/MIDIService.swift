...
final class MIDIService: ObservableObject {
    ...
    func start() async {
        ...
        do {
            let manager = MIDIManager(
                clientName: "Manatee",
                model: "Manatee Audio Controller",
            ...
            inputConnection = manager.managedInputConnections["Manatee-Input"]
    ...
    private var mappingsURL: URL {
        ...
        let dir = appSupport.appendingPathComponent("Manatee", isDirectory: true)
