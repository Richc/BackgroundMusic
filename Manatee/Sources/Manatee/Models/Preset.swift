...
final class PresetStore: ObservableObject {
    ...
    init() {
        ...
        let manateeDir = appSupport.appendingPathComponent("Manatee", isDirectory: true)
        
        // Create directory if needed
        try? FileManager.default.createDirectory(at: manateeDir, withIntermediateDirectories: true)
        
        presetsURL = manateeDir.appendingPathComponent("presets.json")
        scenesURL = manateeDir.appendingPathComponent("scenes.json")
