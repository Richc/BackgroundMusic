...
/// Flo Device UID constants (must match BGM_Types.h)
struct BGMDeviceUIDs {
    static let main = "FloDevice"
    static let uiSounds = "FloDevice_UISounds"
    static let nullDevice = "FloNullDevice"
}
...
/// Bridge to communicate with the Flo virtual audio device
@MainActor
