...
struct AudioDevice: Identifiable, Hashable {
    ...
    /// Is this a virtual device (like Flo's virtual device)
    let isVirtual: Bool
    ...
    /// Check if this is the Flo virtual device
    var isFloDevice: Bool {
        uid.contains("Flo") || uid.contains("BGM")
    }
}
    ...
    static func getAllDevices() -> [AudioDevice] {
        ...
        return deviceIDs.compactMap { deviceID -> AudioDevice? in
            ...
            return AudioDevice(
                ...
                isDefault: isDefault,
                isVirtual: manufacturer.contains("Flo") || 
                          manufacturer.contains("Flo") ||
