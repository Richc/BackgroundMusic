...
#ifndef Flo_Bridging_Header_h
#define Flo_Bridging_Header_h
...
extern BOOL FloAudioSystemInitialize(void);

/// Shutdown the audio system
extern void FloAudioSystemShutdown(void);

/// Check if the virtual device driver is installed
extern BOOL FloIsDriverInstalled(void);

/// Get driver version string
extern NSString * _Nullable FloGetDriverVersion(void);


// MARK: - Constants

/// Notification names
extern NSString * _Nonnull const kFloAudioClientsChangedNotification;
extern NSString * _Nonnull const kFloDeviceListChangedNotification;
extern NSString * _Nonnull const kFloVolumeChangedNotification;


#endif /* Flo_Bridging_Header_h */
