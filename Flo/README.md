...
### Menu Bar
Click the Flo icon in the menu bar to access quick volume controls for running applications.
...
│   │   └── Views/         # SwiftUI views
│   └── FloBridge/     # Objective-C bridge for driver
├── Tests/                 # Unit tests
...
Flo uses a virtual audio device driver based on [BackgroundMusic](https://github.com/kyleneideck/BackgroundMusic). The driver intercepts audio from applications, allowing per-app volume control before routing to the physical output.
